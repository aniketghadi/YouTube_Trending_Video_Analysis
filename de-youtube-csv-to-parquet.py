...
S3bucket_node1 = glueContext.create_dynamic_frame.from_catalog(
    database="de-youtube-raw-database",
...
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "ApplyMapping_node2")
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    frame=ApplyMapping_node2,
    connection_type="s3",
    format="glueparquet",
    connection_options={
        "path": "s3://de-youtube-cleansed-us-east-1-040223/youtube/csv_data/",
